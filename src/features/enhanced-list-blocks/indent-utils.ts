// NOTE: Enhanced List Blocks treats tabs using Markdown's indentation semantics:
// a tab advances to the next 4-column stop. Do not use editor tabSize here, or
// save-time normalization can change list nesting.
