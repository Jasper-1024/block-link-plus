...
export class Settings {
  ...
  get overrideTabBehaviour() {
    return this.enabled && this.values.betterTab;
  }
  ...
  get overrideEnterBehaviour() {
    return this.enabled && this.values.betterEnter;
  }
  ...
  get overrideVimOBehaviour() {
    return this.enabled && this.values.betterVimO;
  }
  ...
  get overrideSelectAllBehaviour() {
    return this.enabled && this.values.selectAll;
  }
  ...
  get betterListsStyles() {
    return this.enabled && this.values.styleLists;
  }
  ...
  get verticalLines() {
    return this.enabled && this.values.listLines;
  }
  ...
  get verticalLinesAction() {
    return this.enabled ? this.values.listLineAction : "none";
  }
  ...
  get dragAndDrop() {
    return this.enabled && this.values.dnd;
  }
