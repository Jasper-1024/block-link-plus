// Prototype: debounce requestSave at the view level and measure modify calls for the target file.
(async () => {
  ...
  const tmpPath = `${tmpFolder}/_cdp_save_frequency_debounced_fileonly.md`;
