// Experiment: if FileOutlinerView.requestSave is no-op, does typing still persist / trigger vault.modify?
(async () => {
  ...
  const tmpPath = `${tmpFolder}/_cdp_save_frequency_requestsave_noop.md`;
  ...
  try {
    ...
    // Restore requestSave for cleanup save.
    view.requestSave = origRequestSave;
