## 1. Settings + i18n
- [x] 1.1 Add new plugin settings keys + defaults for Outliner v2 feature toggles (drag/drop, zoom, emphasis line)
...
- [x] 2.3 Gate the active-block left emphasis connector line behind the new toggle (CSS + root class)
