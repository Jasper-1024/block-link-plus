...
- First read docs/agent/runs/BLP-4/context/source-issue.md, docs/agent/runs/BLP-4/context/issue-context.json,
  AGENTS.md, WORKFLOW.md, docs/agent/index.md, and docs/agent/stages/implementation.md.
- Treat docs/agent/stages/implementation.md as the source of truth for your stage identity, scope,
...
Artifact paths:
- required output: docs/agent/runs/BLP-4/implementation.md
