...
- 2026-01-24: Drag/move could consume EOL newline (line-join) (fixed): `docs/debug/2026-01-25-outliner-eol-newline-join.md`
- 2026-01-24: Code block indent flicker after edits (fixed): `docs/enhanced-list/2026-01-24-enhanced-list-codeblock-indent-flicker.md`
- 2026-01-25: Active block highlight left boundary too far left (fixed): `docs/enhanced-list/2026-01-25-enhanced-list-active-highlight-left-offset.md`
